...
export const createCompanySuccess = createAction(
  '[Auth] Create Company Success',
  props<{ data: ModalRedirectData }>()
);
export const createSubdivision = createAction(
  '[Auth] Create Subdivision',
  props<{ subdivision: Subdivision; companyId: number }>()
);
export const createSubdivisionSuccess = createAction(
  '[Auth] Create Subdivision Success',
  props<{ data: ModalRedirectData }>()
);
